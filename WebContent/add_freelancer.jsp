...
<title>Aperto | BrainBnB</title>
	...
	<link rel="stylesheet" href="resources/css/add_freelancer.css" type="text/css" />
...
<%} %>
	...
	<section class="container">
		...
		<section class="cf worker-container">
			<p id="big_p">people</p> <p>(22)</p> 
			<p id="big_p" style="padding-left: 2%">favourites</p> <p>(0)</p>
			...
			<table class="fixed" style="padding-left: 11.2%" id="worker-table">
				...
				<tr>
					<td>
					 <ul>
						<li><figure>
							<img  class="avatar" src="resources/img/foto_gb.jpg">
						</figure>
						</li>
					 </ul>		
					...
					<td>Gerard Butler</td>
					<td>45</td>
					<td><ul><li>English</li><li>Italian</li></ul></td>
					<!--****** GRAPH ******-->
			...
			<table class="fixed" style="padding-left: 11.2%" id="worker-table">
				...
				<tr>
					<td>
					 <ul>
						<li><figure>
							<img  class="avatar" src="resources/img/foto_bp.jpg">
						</figure>
						</li>	
					 </ul>	
						<label class="add-fav"><input type="checkbox" />
			...
			<table class="fixed" style="padding-left: 11.2%" id="worker-table">
				...
				<tr>
					<td>
					 <ul>
						<li><figure>
							<img  class="avatar" src="resources/img/foto_ch.png">
						</figure>
						</li>	
					 </ul>	
						<label class="add-fav"><input type="checkbox" />
