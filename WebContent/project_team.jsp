	...
	<section class="container">
	  <div id="pattern" class="pattern">
			...
			<nav class="navigation" role="navigation">
				<ul class="nav-list">
				     <li><i id="intmenuicon" class="fa fa-circle-o"><a href="ShowTeamServlet"> member</a></i></li>
				     <li><i id="intmenuicon" class="fa fa-circle-o"><a href="AddWorkerServlet?id=<%=id%>"> add worker</a></i></li>
